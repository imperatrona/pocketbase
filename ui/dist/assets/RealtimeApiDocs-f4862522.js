import{S as re,i as ae,s as be,N as ue,C as P,e as u,w as y,b as a,c as te,f as p,g as t,h as I,m as ne,x as pe,t as ie,a as le,o as n,d as ce,R as me,p as de}from"./index-1056580c.js";import{S as fe}from"./SdkTabs-1f38a930.js";function $e(o){var B,U,W,A,H,L,T,q,M,N,j,J;let i,D,l=o[0].name+"",b,m,h,d,_,f,k,c,S,$,w,v,C,R,E,r,g;return c=new fe({props:{js:`
    ...
    `}}),r=new ue({props:{content:JSON.stringify({action:"create",record:P.dummyCollectionRecord(o[0])},null,2).replace('"action": "create"','"action": "create" // create, update or delete')}}),{c(){i=u("h3"),D=y("Realtime ("),b=y(l),m=y(")"),h=a(),d=u("div"),d.innerHTML=`<p>Subscribe to realtime changes via Server-Sent Events (SSE).</p> 
    <p>Events are sent for <strong>create</strong>, <strong>update</strong>
        and <strong>delete</strong> record operations (see &quot;Event data format&quot; section below).</p>`,_=a(),f=u("div"),f.innerHTML=`<div class="icon"><i class="ri-information-line"></i></div> 
    <div class="contet"><p><strong>You could subscribe to a single record or to an entire collection.</strong></p> 
        ...
        <p>When you subscribe to an <strong>entire collection</strong>, the collection&#39;s
            ...
            event message.</p></div>`,k=a(),te(c.$$.fragment),S=a(),$=u("h6"),$.textContent="API details",w=a(),v=u("div"),v.innerHTML=`<strong class="label label-primary">SSE</strong> 
    <div class="content"><p>/api/realtime</p></div>`,C=a(),R=u("div"),R.textContent="Event data format",E=a(),te(r.$$.fragment),p(i,"class","m-b-sm"),p(d,"class","content txt-lg m-b-sm"),p(f,"class","alert alert-info m-t-10 m-b-sm"),p($,"class","m-b-xs"),p(v,"class","alert"),p(R,"class","section-title")},m(e,s){t(e,i,s),I(i,D),I(i,b),I(i,m),t(e,h,s),t(e,d,s),t(e,_,s),t(e,f,s),t(e,k,s),ne(c,e,s),t(e,S,s),t(e,$,s),t(e,w,s),t(e,v,s),t(e,C,s),t(e,R,s),t(e,E,s),ne(r,e,s),g=!0},p(e,[s]){var Y,z,F,G,K,Q,X,Z,x,ee,se,oe;(!g||s&1)&&l!==(l=e[0].name+"")&&pe(b,l);const O={};s&3&&(O.js=`
        import PocketBase from 'pocketbase';
    ...
    `),c.$set(O);const V={};s&1&&(V.content=JSON.stringify({action:"create",record:P.dummyCollectionRecord(e[0])},null,2).replace('"action": "create"','"action": "create" // create, update or delete')),r.$set(V)},i(e){g||(ie(c.$$.fragment,e),ie(r.$$.fragment,e),g=!0)},o(e){le(c.$$.fragment,e),le(r.$$.fragment,e),g=!1},d(e){e&&n(i),e&&n(h),e&&n(d),e&&n(_),e&&n(f),e&&n(k),ce(c,e),e&&n(S),e&&n($),e&&n(w),e&&n(v),e&&n(C),e&&n(R),e&&n(E),ce(r,e)}}}function ve(o,i,D){let l,{collection:b=new me}=i;return o.$$set=m=>{"collection"in m&&D(0,b=m.collection)},l=P.getApiExampleUrl(de.baseUrl),[b,l]}class De extends re{constructor(i){super(),ae(this,i,ve,$e,be,{collection:0})}}export{De as default};
